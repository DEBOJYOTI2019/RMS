    ...
    <div class="d-flex flex-row">
        <div class="col-md-3">
            <div class="card card1 p-3">
                ...
                <hr class="hline">
                <div class="d-flex flex-column align-items-center"> <button class="btn"><i class="fa fa-dashboard"></i><a href="Employee.php"style="text-decoration:none; color:white; font-size:18px;"><span style="font-size:18px;">Dashboard</span></a></button>
                <button class="btn"><i class="fa fa-dashboard"></i><a href="../bill/bill.php" style="color:white; text-decoration:none;"><span >Customer Billing</span></a></button>  
