...
<html lang="en">
  ...
  <div class="container">
    <div class="card">
      <form action="recover_submit.php" method="post">
        <div class="form" >
            <div class="left-side"> <span></span> <span></span> <span></span> <span></span> </div>
            <div class="right-side">
                <div class="signin_form s_form ">
                    <div class="login">
                    <h4>Recovery @ RMS<br></h4>
                    </div>
                    <div class="input_text"> <input type="password" name="password" placeholder="New Password" required> <i class="fa fa-user"></i> </div>
                    <div class="input_text"> <input type="password" name="code" placeholder="Code" required> <i class="fa fa-user"></i> </div>
                    <div class="login_btn"> <button class="login_button">SEND</button> </div>
                   <p>Click on Submit Button to confirm your new password.</p>
                      </div>
