						...
						<table class="cart-table">
							<thead class="cart-table-head">
								<tr class="table-head-row">
									...
									<th class="product-image"><input type="date" id="txtDate" name="date" required></input></th>
									<th class="product-name"><input type="time"  min="12:30" max="21:00" name="time" required></input></th>
                                    
									<th class="product-name"><a style="text-decoration:none;"><button class="btn btn-success">Check Availability</button></a></th>
									</form>
								</tr>
							</thead>
							...
							<tbody>
								<tr class="table-body-row">
									...
									<td class="product-image"><button class="btn btn-light" ><img src="assets/img/T1success.png" alt=""></button></td>
									<td class="product-image"><button class="btn btn-light"><img src="assets/img/T2success.png" alt=""></button></td>
                                    <td class="product-image"><button class="btn btn-light" alt=""><img src="assets/img/T3success.png" alt=""></button></td>
                                    
								</tr>
								<tr class="table-body-row">
                                <td class="product-image"></td>
                                <td class="product-image"><button class="btn btn-light" ><img src="assets/img/T4success.png" alt=""></button></td>
                                <td class="product-image"><button class="btn btn-light" ><img src="assets/img/T5success.png" alt=""></button></td>
                                
								</tr>
								<tr class="table-body-row">
									<td class="product-image"><button class="btn btn-light"><img src="assets/img/T6success.png" alt=""></td>
                                    <td class="product-image"><button class="btn btn-light"><img src="assets/img/T7success.png" alt=""></button></td>
                                    <td class="product-image"><button class="btn btn-light"><img src="assets/img/T8success.png" alt=""></button></td>
								</tr>
							</tbody>
						</table>
					</div>
...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  ...
  <div class="form-group">
    ...
    <input type="date" class="form-control" name="dte" id="exampleInputPassword1">
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Timing:</label>
    <input type="time" class="form-control" name="tm" id="exampleInputPassword1">
  </div>
